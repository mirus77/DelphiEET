...
//  procedure xmlSecAddIDs (doc: xmlDocPtr; cur: xmlNodePtr; const ids: xmlCharPtrPtr); cdecl; external LIBXMLSEC_SO;
  ...
  function xmlSecBase64GetDefaultLineSize():LongInt; cdecl; external LIBXMLSEC_SO;
  procedure xmlSecBase64SetDefaultLineSize(columns: LongInt); cdecl; external LIBXMLSEC_SO;
  ...
  function xmlSecCryptoAppKeyLoad (const filename: PAnsiChar; format: xmlSecKeyDataFormat; const pwd: PChar; pwdCallback: Pointer; pwdCallbackCtx: Pointer) : xmlSecKeyPtr; cdecl; external LIBXMLSEC_SO;
